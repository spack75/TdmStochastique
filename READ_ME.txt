...
deterministe.py   : contient les fonctions requises pour la résolution du système d'équations déterministe
...
Pour la fonction etude_GammaBeta_2D, puisqu'elle renvoie deux tracés, il faudra mettre True, True, "nom1", "nom2".

Les images s'enregistrent dans le même dossier où est executé main.py
